...
export default function HomePage() {
    return (
        <>
            <Head>
                <title>Géopolynésie - Expert en Hydrographie et Topographie</title>
                <meta
                    name="description"
                ...
                <meta property="og:title" content="Géopolynésie - Expert en Hydrographie et Topographie" />
                <meta
                ...
                <meta name="twitter:title" content="Géopolynésie - Expert en Hydrographie et Topographie" />
                <meta
