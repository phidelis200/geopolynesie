...
const ServicePage = () => {
  const services = [
    ...
    },
    {
      ...
      title: "Bathymétrie",
      description:
        "Notre expertise en bathymétrie permet de mesurer avec précision les profondeurs et le relief des fonds marins dans tous types d'environnements.",
      icon: <Compass size={40} className="text-ocean-500" />,
      features: [
        "Mesure des profondeurs et reliefs sous-marins",
        "Utilisation de sondeurs mono et multi-faisceaux",
        "Cartographie précise des fonds marins",
        "Modèles numériques de terrain sous-marin",
        "Études d'évolution morphologique des fonds",
        "Détection d'objets et d'anomalies sous-marines",
      ],
            ...
            {services.map((service, index) => (
              ...
              >
                <div className="md:w-1/2">
                  ...
                  <Link href="/contact-us" className="btn-ocean">
