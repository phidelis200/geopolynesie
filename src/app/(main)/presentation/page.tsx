      ...
      <div className="bg-white py-8 md:py-16">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link
              href="/contact-us"
              className="flex items-center gap-2 justify-center btn-ocean px-6 py-3 border-2 border-ocean-600"
            >
            ...
            <Link
              href="/services"
              className="flex items-center gap-2 justify-center btn-outline-ocean"
            >
